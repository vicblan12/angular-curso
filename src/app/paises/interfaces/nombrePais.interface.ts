...
export class Convert {
    public static toNombrePaises(json: string): NombrePaises[] {
        return cast(JSON.parse(json), a(r("NombrePaises")));
    }

    public static nombrePaisesToJson(value: NombrePaises[]): string {
        return JSON.stringify(uncast(value, a(r("NombrePaises"))), null, 2);
    }
}
